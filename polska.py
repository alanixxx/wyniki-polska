...
# KOMPLETNA LISTA MECZÓW 2019 - 2026
mecze = [
    # --- 2026 ---
    ...
    # ... (Mecze 2025 i 2024 pozostają bez zmian w logice)
...
for m in mecze:
    ...
    # Logika wyświetlania gospodarza (uwzględnia poprawkę dla Hiszpanii na Euro)
    if m['miejsce'] == "dom" or m['miejsce'] == "neutralny":
        l_n, l_f = "POLSKA", flaga_pl
        p_n, p_f = m['o'].upper(), m['f']
        w_wys = formatuj_wynik(m['w'], kolor_wyniku)
    elif m['miejsce'] == "neutralny_gosc": # Specjalny przypadek dla meczu z Hiszpanią

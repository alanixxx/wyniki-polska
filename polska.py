...
# KOMPLETNA LISTA MECZÓW (Z WSZYSTKICH SCREENÓW)
mecze = [
    # --- Screen 1 & 2 (Najnowsze + Baraże) ---
...
for m in mecze:
    ...
    if m['miejsce'] == "dom":
        ...
        # Logika odwracania wyniku dla meczów wyjazdowych
        if "(" in m['w']:
            c = m['w'].split(" ")
            ...
            res = m['w'].split(" : ")
            w_wyswietl = formatuj_wynik(f"{res[1]} : {res[0]}", kolor_wyniku)
